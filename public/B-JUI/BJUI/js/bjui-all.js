    ...
    Datagrid.prototype.TOOLS = function() {
        ...
        var tools = {
            ...
            appendColumns: function() {
                ...
                that.editBtnsColumn   = {name:'gridEdit', gridEdit:true, width:110, minWidth:110, label:(typeof options.showEditbtnscol === 'string' ? options.showEditbtnscol : '操作'), align:'center', menu:false, edit:false, hide:false, quicksort:false}
            },
            // setBoxb - height
