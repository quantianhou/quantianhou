    ...
    <div style="padding:15px; height:100%;width:99.8%" >
        ...
        <table id="shop_store_serarch_form-table"   data-toggle="datagrid" data-options="{
			...
			columns: [
                ...
                {name: 'provincecode', width: 150, align:'center', label: '省'},
                {name: 'citycode', width: 180, align:'center', label: '市'},
                {name: 'areacode', width: 180, align:'center', label: '区'},
                {name: 'merchant_name', width: 70, align:'center', label: '商家名称'},
                {name: 'store_short_name', width: 70, align:'center', label: '门店名称'},
                {name: 'merchant_type_name', width: 70, align:'center', label: '门店简称'},
